<template>
    <div id="login">
        ...
        <section>
            <div class="col1">
                <h1>E - Gram</h1>
                <p>Welcome to the <a href="https://eoasiamah.engineerskasa.com/" target="_blank">EKITs</a> sample social media web app powered by Vue.js and Firebase.
            ...
            <div :class="{'signup-form': !showLoginForm}" class="col2">
                ...
                <form v-else @submit.prevent>
                    ...
                    <div>
                        ...
                        <input v-model.trim="signupForm.name" type="text" placeholder="EK Apps" id="name" />
                    </div>
                    <div>
